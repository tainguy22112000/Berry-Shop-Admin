...
const ProductOrderLists = Loadable(
  lazy(() => import('../views/products/ProductOrderLists')),
);
const ProductOrderDetails = Loadable(
  lazy(() => import('../views/products/ProductOrderDetails')),
);
const ProductLists = Loadable(
  lazy(() => import('../views/products/ProductLists')),
);
